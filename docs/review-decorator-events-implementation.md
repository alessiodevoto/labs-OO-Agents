...
**File**: `src/nooa/decorators.py:62-66`
```python
...
**File**: `src/nooa/runtime/context_builder.py:378-426`
...
**File**: `src/nooa/runtime/actor.py:110-117`
...
**File**: `src/nooa/runtime/context_builder.py:419`
