...
**Date:** 2026-03-09
**Issue:** [#116](https://gitlab-master.nvidia.com/interactive-agents/agent006/-/issues/116) — `execute_code()` blocks event loop
**Related:** [!327](https://gitlab-master.nvidia.com/interactive-agents/agent006/-/merge_requests/327) — restricted imports
...
`src/agent006/runtime/restrictions.py` — single source of truth for all module restrictions, consumed by both the startup import checker (!327) and the runtime validator.
