...
:func:`nemo_oo_agents.config.get_model_config` /
:func:`nemo_oo_agents.config.resolved_config` to get validated objects
...
class ModelConfig(BaseModel):
    ...
    def from_registry(cls, name: str, raw: dict[str, Any]) -> ModelConfig:
        ...
        mirroring :func:`nemo_oo_agents.unifiedllm.get_llm_client`.
        """
        data = dict(raw)
