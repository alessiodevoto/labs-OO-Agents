...
a typed :class:`ResolvedConfig` rather than raw dicts.
    ...
    from nemo_oo_agents.config import resolved_config
...
class Secrets(BaseModel):
    ...
    ``os.environ`` by :func:`nemo_oo_agents.secrets.load_secrets_into_env`,
...
def get_model_config(name: str) -> ModelConfig | None:
    ...
    from nemo_oo_agents.unifiedllm.registry import _registry_lock, ensure_loaded
...
def resolved_config() -> ResolvedConfig:
    ...
    from nemo_oo_agents.llm_config import bundled_config_paths, llm_config_chain
