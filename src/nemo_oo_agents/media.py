...
Provides media classes for passing rich content (images, audio, files) to
LLMs via the show() builtin in CodeAct or as parameters to generation methods.
...
class Media:
    ...
    Subclasses define the modality (image, audio, file) which determines
    how the content block is rendered for the LLM.

    Use the subclasses directly: Image, Audio, File.
    """
