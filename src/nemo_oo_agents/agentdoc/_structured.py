...
from nemo_oo_agents.agentdoc._info import REQUIRED, CallableInfo, FieldInfo, ModuleInfo, TypeInfo
from nemo_oo_agents.agentdoc.protocols import SupportsCallableInfo, SupportsTypeInfo
...
def _extract_methods(obj: type) -> list[CallableInfo]:
    ...
    from nemo_oo_agents.agentdoc._metadata import _FIELDS_ATTR  # noqa: PLC0415
