...
from nemo_oo_agents.agentdoc._info import REQUIRED, CallableInfo, ModuleInfo, TypeInfo
from nemo_oo_agents.agentdoc._metadata import is_expand_false
from nemo_oo_agents.agentdoc._structured import _ClassRef, _InstanceRef
from nemo_oo_agents.agentdoc.protocols import SupportsInstanceValues
    ...
    *,
    ...
    match _object:
        ...
        case _ if inspect.ismodule(_object):
            from nemo_oo_agents.agentdoc.registry import get_module_info_extractor

            extractor = get_module_info_extractor(_object)
            if extractor is not None:
                module_info = extractor(_object)
            else:
                from nemo_oo_agents.agentdoc._structured import extract_module_info
        ...
        case _ if _is_structured_instance(_object):
            ...
            if instance_mode == "type":
                ...
                from nemo_oo_agents.agentdoc.protocols import SupportsInstanceValues
                from nemo_oo_agents.agentdoc.registry import get_type_info_extractor
...
def _format_type_info(
    ...
    *,
    ...
    if context_obj is not None and type_depth > 0:
        from nemo_oo_agents.agentdoc._discover import (
...
def _format_instance_repr(
    ...
    *,
    ...
    if extractor:
        ...
        from nemo_oo_agents.agentdoc._visibility import is_hidden_field  # noqa: PLC0415
