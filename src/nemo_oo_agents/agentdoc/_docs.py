...
from nemo_oo_agents.agentdoc._metadata import set_docs_metadata, set_field_metadata
    ...
    def define_doc(self, target) -> Any:
        ...
        **For a module** — extractor receives the module, returns ``ModuleInfo``::
        ...
        if inspect.ismodule(target):
            from nemo_oo_agents.agentdoc.registry import register_module_info_extractor

            return register_module_info_extractor(target)

        from nemo_oo_agents.agentdoc.registry import register_type_info_extractor
