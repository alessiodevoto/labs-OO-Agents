...
def _encode_image(img: Any) -> str:
    ...
    JSON.  Must match :func:`nemo_oo_agents.tracing._litellm_journal._skeleton_dict_message`
...
def build_journal_payload(messages: list[Any]) -> JournalPayload:
    ...
    :class:`nemo_oo_agents.tracing._litellm_journal.MessageJournalCallback`
