...
- **Guides** ([`docs/guides/`](docs/guides/)) — [prompt mechanics](docs/guides/prompt-mechanics.md), [writing generation methods](docs/guides/writing-generation-methods.md), [strategies](docs/guides/strategies.md), [structured output](docs/guides/structured-output.md), [context blocks](docs/guides/context-blocks.md), [truncation](docs/guides/truncation.md), [single vs. multi-agent](docs/guides/single-vs-multi-agent.md), [config migration](docs/guides/config-migration.md), and [sandboxing your application](docs/guides/sandboxing-your-application.md).
