...
from nemo_oo_agents_cli.tui.memory_explorer import (
    MemoryExplorerView,
    build_memory_rows,
    relative_age,
)
...
from nemo_oo_agents.memory.config import ReflectionPolicy, SpontaneousConfig, WritePolicy
...
def test_last_reflection_summary_lines():
    ...
    from nemo_oo_agents_cli.tui.memory_explorer import last_reflection_summary
