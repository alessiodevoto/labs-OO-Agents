...
``~/.config/nemo_oo/settings.yaml`` the first time the TUI launches (when no
...
from nemo_oo_agents_cli.tui.bootstrap import _scaffold_settings
from nemo_oo_agents_cli.tui.config import Config
from nemo_oo_agents_cli.tui.settings import SETTINGS_TEMPLATE, render_settings_template
