...
class BaseTUIAgent(Agent, llm=_DEFAULT_LLM):
    ...
    **Input queues.** Every ``BaseTUIAgent`` has a ``self.user_messages``
    ...
    # TUI-owned system/internal prompts, e.g. keep-going continuations.
    ...
    # System/internal prompts generated by the TUI.
    ...
    async def handle(
        ...
        All stop reasons use the same dispatcher wake path: the TUI races every
        ...
        - ``"system_messages"`` — TUI-owned system/internal prompts,
