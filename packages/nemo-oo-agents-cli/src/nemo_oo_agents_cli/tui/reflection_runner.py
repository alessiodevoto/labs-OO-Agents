...
try:  # optional-import pattern mirrored from nemo_oo_agents.memory.tracing_bridge
    from opentelemetry import trace as _ot_trace
except ImportError:  # pragma: no cover - exercised only without the tracing extra
    _ot_trace = None

if TYPE_CHECKING:
    from nemo_oo_agents.memory.manager import MemoryManager
...
class ReflectionRunner:
    ...
    async def _run(self) -> None:
        ...
        if self._episode_writer is not None:
            from nemo_oo_agents.memory.generative import render_recent_events
    ...
    def _reflect_in_thread(self, events_text: str = "") -> ReflectionReport:
        ...
        tracer = _ot_trace.get_tracer("nemo_oo_agents_cli.tui.reflection")
    ...
    def _write_episode(self, events_text: str) -> None:
        ...
        from nemo_oo_agents.memory import MemoryType
