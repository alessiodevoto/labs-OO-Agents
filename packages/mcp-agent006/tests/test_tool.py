...
async def test_create_generates_dynamic_tool_class_with_methods():
    ...
    mock_session.call_tool.assert_awaited_once_with("definition", {"filepath": "src/main.py", "line": 10})
...
async def test_create_with_custom_child_class_uses_child_class():
    ...
    tool_specs = [
        ...
        MCPToolSpec("definition", "Get definition", {"type": "object", "properties": {}}, server="srv"),
    ]
...
async def test_parameter_with_default_none_gets_union_type():
    ...
    mock_session.call_tool.assert_awaited_once_with("search", {"query": "test3", "cursor": "abc123"})
