...
"""Tests for truncating_pformat — bounded pre-serialization helper."""
...
class TestSafePformat:
    """truncating_pformat must never OOM and must include a truncation notice when capped."""
    ...
    def test_none_value(self):
        """None formats safely."""
        result = truncating_pformat(None)
        assert result == "None"
    ...
    def test_dict_is_bounded(self):
        ...
        result = truncating_pformat(big_dict)
    ...
    def test_string_head_tail_50_50_split(self):
        ...
        s = "A" * 500 + "x" + "Z" * 500
        result = truncating_pformat(s, max_chars=1000)
    ...
    def test_nonstring_abort_early_bounded(self):
        ...
        result = truncating_pformat(big, max_chars=5000)
