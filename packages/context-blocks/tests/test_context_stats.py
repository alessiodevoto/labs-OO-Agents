...
from context_blocks.formatter import OpenAIProviderFormatter, XMLBlockFormatter
from context_blocks.models import BlockMetadata, ContextWindowStats, ResolvedBlock, Role
from context_blocks.renderer import RenderResult, render_context
...
class TestContextWindowStatsEdgeCases:
    ...
    def test_exports_from_context_blocks_package(self):
        ...
        from context_blocks import ContextWindowStats as CWS
        from context_blocks import RenderResult as RR
