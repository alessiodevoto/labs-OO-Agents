...
_scoped_blocks_var: contextvars.ContextVar[dict[str, str | DynamicContext | None] | None] = contextvars.ContextVar(
    "scoped_blocks", default=None
)
...
_scoped_events_var: contextvars.ContextVar["EventQuery | None"] = contextvars.ContextVar("scoped_events", default=None)
