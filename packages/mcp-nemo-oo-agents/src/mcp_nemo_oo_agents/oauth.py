        ...
        class CallbackHandler(BaseHTTPRequestHandler):
            ...
            def do_GET(self) -> None:
                ...
                if "error" in params:
                    ...
                    body = _html_page("Unexpected Response", "<p>No code received. You can close this tab.</p>")
        ...
        for path in well_known_paths:
            try:
                ...
                if response.status_code == 200:
                    ...
                    discovered_client_id = discovered_client_id or data.get("client_id") or data.get("clientId")
                    break
            except Exception:
                continue
            ...
            try:
                async with httpx.AsyncClient() as client:
                    ...
                    if response.status_code == 201 or response.status_code == 200:
                        ...
                        logger.warning(f"Client registration failed: {response.status_code} {response.text}")
            except Exception as e:
