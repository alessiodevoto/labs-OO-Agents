...
class MCPSSEClient(MCPBaseClient):
    ...
    async def connect_to_server(self):
        ...
        """
        async with sse_client(url=self._url) as (read, write), ClientSession(read, write) as session:
...
def create_mcp_client(
    ...
    match transport:
        ...
        case _:
            raise ValueError(f"Unsupported transport type: {transport}. Use 'stdio', 'sse', or 'streamable-http'")
