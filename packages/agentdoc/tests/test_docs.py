...
from agentdoc._docs import SpecAnnotation, spec
from agentdoc._metadata import get_docs_metadata, get_field_metadata
...
class TestDefineDocEndToEnd:
    def test_define_doc_type_only_path(self):
        ...
        from agentdoc.registry import clear_registry
