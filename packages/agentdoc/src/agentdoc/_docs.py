...
from agentdoc._metadata import set_docs_metadata, set_field_metadata
    ...
    **Default visibility rules:**
    ...
    def __call__(
        ...
        *,
        ...
        expand: Annotated[bool | None, "If False, collapse sub-type to a one-liner in doc()"] = None,
        ...
        **not** the Agent006 generation-method ellipsis — it just means "omit
    ...
    def define_doc(self, target) -> Any:
        ...
        **For a module** — extractor receives the module, returns ``ModuleInfo``::
        ...
        if inspect.ismodule(target):
            from agentdoc.registry import register_module_info_extractor
