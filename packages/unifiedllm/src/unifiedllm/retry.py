...
class EmptyContentError(Exception):
    ...
    def __init__(self, reasoning: str | None = None):
        ...
        super().__init__(f"Empty content with reasoning: {reasoning[:100]}..." if reasoning else "Empty content")
    ...
    **kwargs: Any,
    ...
    while attempt < max_total_attempts:
        try:
            ...
            max_for_logging = (
                config.max_retries + config.rate_limit_extra_retries if is_rate_limit else config.max_retries
            )
