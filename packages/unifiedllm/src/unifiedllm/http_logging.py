...
def enable_http_request_logging(
    ...
    try:
        ...
        raise ImportError("httpx is required for request logging. Install it with: pip install httpx") from e
        ...
        if errors_only:
            if response.status_code >= 400 and request_data:
                ...
                try:
                    ...
                    if verbose:
                        print(f"🔴 LLM Error captured (#{counter}): {response.status_code} - {model_name}")
