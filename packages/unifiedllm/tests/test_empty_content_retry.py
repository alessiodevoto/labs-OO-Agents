...
from unifiedllm import CompletionClient, EmptyContentError, RetryConfig
...
def make_tool_call(id: str, name: str, arguments: str) -> ChatCompletionMessageToolCall:
    ...
    return ChatCompletionMessageToolCall(id=id, function=Function(name=name, arguments=arguments), type="function")
...
class TestCompletionClientEmptyContentRetry:
    ...
    async def test_tool_calls_bypass_retry(self, client_with_retry):
        ...
        mock_tool_call = make_tool_call(id="call_123", name="test_function", arguments='{"arg": "value"}')
    ...
    @pytest.mark.asyncio
    async def test_tool_calls_with_none_content_stores_empty_string_in_assistant_message(self, client_with_retry):
