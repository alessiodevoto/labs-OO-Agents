...
import pytest
from nooa_tui.tui.commands import EventsCommand
from nooa_tui.tui.event_explorer import (
    EventExplorerModel,
    EventExplorerRow,
    build_event_rows,
...
def test_event_explorer_advertises_q_close() -> None:
    ...
    source = Path("packages/nooa-tui/src/nooa_tui/tui/event_explorer.py").read_text()
...
def test_event_explorer_has_in_app_mouse_scroll_bindings() -> None:
    source = Path("packages/nooa-tui/src/nooa_tui/tui/tui_application.py").read_text()
...
def _session_row(id: str, name: str, turns: list[tuple[str, str]]):
    from nooa_tui.tui.session_explorer import SessionExplorerRow
    from nooa_tui.tui.session_manager import Turn
...
def test_session_explorer_model_searches_across_sessions_and_dialog() -> None:
    from nooa_tui.tui.session_explorer import SessionExplorerModel
...
def test_session_explorer_navigation_tab_and_rendering() -> None:
    from nooa_tui.tui.session_explorer import (
...
def test_session_explorer_tab_switches_fts_scope_with_pane() -> None:
    from nooa_tui.tui.session_explorer import SessionExplorerModel, SessionExplorerView
...
def test_session_explorer_view_fts_accepts_navigation_and_quit_chars() -> None:
    from nooa_tui.tui.session_explorer import SessionExplorerView
...
async def test_session_list_opens_in_app_explorer_when_available() -> None:
    from nooa_tui.tui.commands import SessionCommand
...
async def test_tui_app_opens_and_closes_session_explorer_in_app(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "nooa_tui.tui.session_explorer.build_session_rows",
