...
from nooa_tui.tui.keep_going import KeepGoingDecision
from nooa_tui.tui.tui_application import DispatcherExit, TUIApplication
...
def test_dispatcher_keep_going_queues_assistant_message_before_waiting(monkeypatch):
    ...
    from nooa_tui.tui import keep_going as keep_going_mod
...
def test_coalesce_string_into_queue_non_string_tail_preserves_both():
    ...
    """
    from nooa_tui.tui.tui_application import _coalesce_string_into_queue
