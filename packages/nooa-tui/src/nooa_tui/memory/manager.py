...
from nooa_tui.memory.config import MemoryConfig
from nooa_tui.memory.descriptors import to_numeric, to_status
from nooa_tui.memory.embeddings import Embedder, get_embedder
...
from nooa_tui.memory.references import capture, parse_ref, render, resolve
from nooa_tui.memory.reflection import ReflectionEngine, ReflectionReport
from nooa_tui.memory.retrieval import RetrievalEngine, derive_queries
...
from nooa_tui.memory.tracing_bridge import current_trace_ref, install_tracing_bridge

logger = logging.getLogger(__name__)
# Dedicated logger for memory-usage monitoring/debug (raise to DEBUG to trace ops).
mem_logger = logging.getLogger("nooa_tui.memory")
