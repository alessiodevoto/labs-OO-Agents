...
from nooa_tui.memory.schema import Edge, EdgeType, Memory, MemoryType
...
class MemoryStore:
    ...
    def add_edge(
        ...
        from nooa_tui.memory.schema import _now
    ...
    def keyword_search(
        ...
        *,
        ...
        from nooa_tui.memory.embeddings import _TOKEN_RE
