...
async def bootstrap(
    ...
    *,
    ...
    # ------------------------------------------------------------------
    # Settings — scaffold ~/.config/nooa/settings.yaml on first run
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    from nooa.unifiedllm import FakeLLMClient as _FakeLLMCheck
    ...
    # ------------------------------------------------------------------
    # Rich content replay (nooa term, session resume only)
    # ------------------------------------------------------------------
    ...
    if _resumed and _os.environ.get("NEMO_OO_RICH_URL"):
        try:
            ...
            from nooa.tools.web_publisher import WebPublisher as _WP
