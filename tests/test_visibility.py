...
def test_filter_exec_globals_excludes_annotated_hidden_variable():
    ...
    from nemo_oo_agents.agentdoc.visibility import filter_module_globals, is_hidden_module_variable
    ...
    import nemo_oo_agents.agentdoc as vis
...
def test_is_hidden_field_with_future_annotations():
    ...
    import nemo_oo_agents.agentdoc._visibility as vis_mod
