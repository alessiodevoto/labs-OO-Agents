...
echo "     [ ! -f .env ] && echo 'NVIDIA_API_KEY=your-key-here' > .env"
echo ""
echo "  3. Run tests:"
echo "     uv run pytest tests/"
echo ""
echo "  4. Run evaluation experiments:"
echo "     uv run python experiments/evaluation-ablations/run_ablation.py --help"
echo ""
