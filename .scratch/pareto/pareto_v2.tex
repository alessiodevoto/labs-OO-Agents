...
\begin{semilogxaxis}[
  ...
  legend style={
    at={(0.5,-0.13)}, anchor=north, legend columns=5,
...
% ===== leader lines (drawn first, under markers) =====
% left gpt-off group
...
% ===== data markers: color=harness, shape=backend, size=effort =====
% NOOA-base (teal)
...
% ===== legend r1: harness color; r2: backend shape =====
...
% nano (labelled beside markers, inside band)
