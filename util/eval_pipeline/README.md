...
Start the viewer (e.g. `nemo_oo_agents start-dev` or the combined viewer on port 5001) before running so the endpoint is available. Experiments will appear in the eval viewer under distinct names (e.g. `capability_20260309_080455_207319_r3_p40`).
